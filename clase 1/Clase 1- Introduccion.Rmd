...
Las __estructuras condicionales__ nos permiten ejecutar código de forma condicional a que se cumpla determinada condición. 
...
```{r}
ifelse(test = class(A) == "character", yes =  print("Esto es un caracter"),
       no = print("Esto no era un caracter"))
