...
Los tipos de datos son una clase de valores que se pueden construir para representar información. Las estructuras de datos es una forma abstracta compleja de representar y guardar información 
...
### Matrices
Son vectores que poseen dimensiones: número de columnas y filas
