...
En la carpeta __fuentes__ se encuentran los archivos __dolar-diario.csv__ y __ipc-mensual.csv__. Con ellos, el objetivo es mirar el movimiento conjunto de ambas series de datos. Para ello

1. Levnatar ambos conjuntos de datos
2. Renombramos la variable del tipo de cambio por algo más sencillo
...
6. Normalizar los datos del IPC con $gather$
7. Creamos las variables fecha, año y mes
8. Graficar el nivel general del IPC
9. Graficar los grupos
10. Unir ambos conjutnos de datos
11. Grafical el dólar contra el nivel general del IPC (tener en cuenta el rango de las variables)
12. Grafical el nivel del dolar contra los grupos del IPC
