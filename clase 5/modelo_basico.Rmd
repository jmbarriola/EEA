...
- map2_dbl nos devuelve un vector con valores double.

Como nuestra función tomaba un único parámetro __a__ para definir los parámetros del modelo, nos armamos una función de ayuda para wrapear a1 y a2
