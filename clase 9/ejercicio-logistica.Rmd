...
5) Analcen la distribución de la clase en ambos datasets
...
1.1) Elijan alguna estrategia para lidiar con los valores faltantes (eliminar registros, imputar media, imputar media por clase, etc)
1.2) Modifiquen variables existentes o creen algunas varaibles nuevas si lo consideran relevante. Por ejemplo: se podría discretizar la edad o como hicieron algunas personas de Kaggle extraer información de los nombres.
