...
$sensitivity = recall = \frac{TP}{T} = \frac{TP}{TP+FN}$
...
La función `glm` puede tomar como argumento una columna (`weigths`) de ponderadores para poder hacer esto. Podemos asignar pesos mayores a 1 a la clase minoritaria (oversampling) o menores a 1 a la clase mayoritaria (undersampling). En nuestro vamos a realizar un sobresampleo de la clase minoritaria.
