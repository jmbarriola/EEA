---
title: "Clase x. Redes Neuronales I^[Estas notas estan basadas en https://tensorflow.rstudio.com/keras/#tutorials]"
...
- Pasar de estos arrays de 3 dimensiones a 1 dimensión (como estamos acostumbrados)
...
```{r}
modelo_preentrenado <- load_model_hdf5("results/fc_model.h5")
```
